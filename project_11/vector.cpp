...
namespace VECTOR
{
    ...
    // reset vector form rectangular coordinates if form is
    ...
    // display rectangular coordinates if mode if RECT,
    // else display polat coordinates if mode is POL
